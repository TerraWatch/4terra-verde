...
lucas_soil_data_writer = DataWriter()
lucas_soil_data_loader = LucasSoilDataLoader(soil_co2_efflux_config)
lucas_soil_data = lucas_soil_data_loader.load_processed_data_csv()
#
